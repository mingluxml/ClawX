/**
 * MiniMax Portal OAuth - Device Flow Implementation
 * Inlined from OpenClaw extensions/minimax-portal-auth/oauth.ts
 * Pure Node.js: only uses node:crypto and global fetch
 */
